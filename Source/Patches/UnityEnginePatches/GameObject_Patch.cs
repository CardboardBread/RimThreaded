...
namespace RimThreaded.Patches.UnityEnginePatches
{
    class GameObject_Patch
    {
        ...
        {
            if (!allWorkerThreads.TryGetValue(CurrentThread, out ThreadState threadInfo)) return __instance.GetComponent<T>();
        ...
        {
            if (!allWorkerThreads.TryGetValue(CurrentThread, out ThreadState threadInfo)) return __instance.AddComponent<T>();
        ...
        {
            if (!allWorkerThreads.TryGetValue(CurrentThread, out ThreadState threadInfo)) return __instance.GetComponent<AudioReverbFilter>();
        ...
        {
            if (!allWorkerThreads.TryGetValue(CurrentThread, out ThreadState threadInfo)) return __instance.GetComponent<AudioLowPassFilter>();
        ...
        {
            if (!allWorkerThreads.TryGetValue(CurrentThread, out ThreadState threadInfo)) return __instance.GetComponent<AudioHighPassFilter>();
        ...
        {
            if (!allWorkerThreads.TryGetValue(CurrentThread, out ThreadState threadInfo)) return __instance.GetComponent<AudioEchoFilter>();
        ...
        {
            if (!allWorkerThreads.TryGetValue(CurrentThread, out ThreadState threadInfo)) return __instance.transform;
