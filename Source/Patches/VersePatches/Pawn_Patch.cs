...
public static class Pawn_Patch
{
    ...
    public static bool PostApplyDamage(Pawn __instance, DamageInfo dinfo, float totalDamageDealt) // not efficient base replacement
    {
    ...
    [HarmonyPrefix]
    [PatchCategory(RimThreadedHarmony.DestructiveCategory)]
    public static bool Destroy(Pawn __instance, DestroyMode mode = DestroyMode.Vanish) // causes strange crash to desktop without error log
    {
