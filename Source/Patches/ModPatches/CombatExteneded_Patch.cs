...
namespace RimThreaded.Patches.ModPatches
{
    class CombatExteneded_Patch
    {
        ...
        public static IEnumerable<CodeInstruction> TryCastShot(IEnumerable<CodeInstruction> instructions, ILGenerator iLGenerator)
        {
            ...
            int i = 0;
            MethodInfo applyMeleeDamageToTarget = Method(typeof(Verb_MeleeAttack), nameof(Verb_MeleeAttack.ApplyMeleeDamageToTarget));
        ...
        public static DamageWorker.DamageResult PreApplyMeleeSlaveSuppression(DamageWorker.DamageResult damageResult, Pawn pawn, Verb_MeleeAttack verb_MeleeAttack)
        {
