...
namespace RimThreaded.Utilities
{
    ...
    public static class PatchClassExtensions
    {
        ...
        internal static List<object> _patchMethods(this PatchClassProcessor processor)
        {
            return (List<object>) _PatchClassProcessor_patchMethods.GetValue(processor);
        }

        internal static Dictionary<Type, MethodInfo> _auxilaryMethods(this PatchClassProcessor processor)
        {
            return (Dictionary<Type, MethodInfo>) _PatchClassProcessor_auxilaryMethods.GetValue(processor);
        }

        internal static List<Type> _auxilaryTypes()
        {
            return (List<Type>) _PatchClassProcessor_auxilaryTypes.GetValue(null);
        }

        internal static HarmonyMethod _info(this object attributePatch)
        {
        ...
        {
            AccessTools.GetTypesFromAssembly(RimThreadedMod.Assembly).Do(AttributeProcessorPatch);
